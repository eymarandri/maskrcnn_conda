...
class MaskRCNN():
    ...
    def build(self, mode, config):
        ...
        if config.GPU_COUNT > 1:
            ...
            #config.gpu_options.per_process_gpu_memory_fraction = 0.70  # 40% of memory
            #configs.log_device_placement = True  # to log device placement (on which device the operation ran)
    ...
    def get_imagenet_weights(self):
        ...
        weights_path = get_file('resnet50COCO_WEIGHTS_PATH_weights_tf_dim_ordering_tf_kernels_notop.h5',
