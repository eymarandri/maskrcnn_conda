...
# Testing
```
python3 nboxes.py singledetect --image=/home/eymar13/maskrcnn_conda/bv13.png  --weights=last
```

```
 python3 nboxes.py singledetect --image=  --weights=last
 tensorboard --logdir=/home/eymar13/maskrcnn_conda/logs
